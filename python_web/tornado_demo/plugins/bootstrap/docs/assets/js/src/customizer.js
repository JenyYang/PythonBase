...
window.onload = function () { // wait for load in a dumb way because B-0
  ...
  function getCustomizerData() {
    ...
    var data = {
      ...
      js:  $('#static-section input:checked').map(function () { return this.value }).toArray()
    }
  ...
  function updateCustomizerFromJson(data) {
    if (data.js) {
      $('#static-section input').each(function () {
  ...
  function generateJS(preamble) {
    var $checked = $('#static-section input:checked')
  ...
  var $inputsPlugin    = $('#static-section input')
  ...
  $('#static-section .toggle').on('click', function (e) {
    e.preventDefault()
