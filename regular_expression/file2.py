...
# # s = "hello alexalex abc alex 19"
# s = "asdasd3asd"
# ret = re.search("a(\w+).*(?P<name>\d)", s)
# # print(ret.group())
# # print(ret.groups())
# # print(ret.groupdict())
# # r = re.findall("a(\w+)x", s)
# # print(r)
# ret_match = re.search("(asd)*", s)
# print(ret_match.group())
# print(ret_match.groups())
...
#   只有执行 python myfile.py 时，以下代码才执行
